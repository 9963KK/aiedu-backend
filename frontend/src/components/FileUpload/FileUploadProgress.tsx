import { FileText, Image, Music2, Video, File as FileIcon } from "lucide-react";
...
export function FileUploadProgress({ file, onCancel }: { file: UploadingFile; onCancel: () => void }) {
  ...
  return (
    <div className="flex items-center justify-between rounded-full border bg-teal-100/70 px-4 py-2 shadow">
